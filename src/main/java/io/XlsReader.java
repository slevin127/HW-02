...
public class XlsReader {
    ...
    public static List<University> readXlsUniversities(String filePath) throws IOException {
        ...
        if (sheet == null) {
            throw new IllegalArgumentException("Лист 'Университеты' отсутствует в файле: " + filePath);
        }
    ...
    public static List<Student> readXlsStudents(String filePath) throws IOException {
        ...
        if (sheet == null) {
            throw new IllegalArgumentException("Лист 'Студенты' отсутствует в файле: " + filePath);
        }
